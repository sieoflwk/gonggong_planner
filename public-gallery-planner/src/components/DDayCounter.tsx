    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <input 
                ...
                className="mt-4 w-full bg-slate-100 dark:bg-slate-800 border-2 border-transparent rounded-lg px-4 py-2 text-center focus:outline-none focus:ring-2 focus:ring-brand-primary-500 focus:border-transparent transition"
            />
        </div>
    );
};
