...
export const EditIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path d="M13.586 3.586a2 2 0 112.828 2.828l-7.778 7.778-4.243 1.414 1.414-4.243 7.778-7.778zM12.172 5L15 7.828l-6.061 6.061-2.121.707.707-2.121L12.172 5z" />
    </svg>
);

export const TrashIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm1 2a1 1 0 000 2h6a1 1 0 100-2H7zm2 4a1 1 0 100 2h2a1 1 0 100-2H9z" clipRule="evenodd" />
    </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path d="M12 14.25a3.375 3.375 0 003.375-3.375V6.375a3.375 3.375 0 00-6.75 0v4.5a3.375 3.375 0 003.375 3.375z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5L12 18l-7.5-4.5" />
...
export const RefreshIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667 0a8.25 8.25 0 0111.667 0l-3.181 3.183m0 0l-3.181-3.183" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348A4.992 4.992 0 0110.5 14.25a4.992 4.992 0 01-5.523-4.902 4.992 4.992 0 015.523-4.902 4.992 4.992 0 015.523 4.902M16.023 9.348L19.5 6.87m-3.477 2.478L19.5 6.87" />
    </svg>
);
