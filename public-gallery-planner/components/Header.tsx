...
import { SunIcon, MoonIcon, QuestionMarkCircleIcon, ChartBarIcon, ArrowLeftIcon } from './shared/icons';
...
export const Header: React.FC<HeaderProps> = ({ theme, onThemeToggle, onHelpClick, view, setView }) => {
    return (
