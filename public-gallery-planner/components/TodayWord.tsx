    ...
    return (
        <Card 
            ...
            action={
                <button 
                    onClick={pickNewWord} 
                    className="p-1.5 text-slate-500 hover:text-brand-primary-500 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
                    aria-label="새 단어"
                >
        ...
        >
            <div className="text-center p-2 perspective-1000">
                {todayWord ? (
                    ...
                    >
                        {/* Front Side */}
                        <div className="absolute w-full h-full backface-hidden flex flex-col items-center justify-center bg-slate-100 dark:bg-slate-800/50 rounded-lg p-4">
                            <h3 className="text-3xl font-bold text-brand-primary-600 dark:text-brand-primary-400">{todayWord.eng}</h3>
                        </div>
                        {/* Back Side */}
                        <div className="absolute w-full h-full backface-hidden rotate-y-180 flex flex-col items-center justify-center bg-brand-primary-100 dark:bg-slate-800 rounded-lg p-4">
